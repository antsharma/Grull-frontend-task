const Sdata = [
  {
    id: 1,
    title: "Experience the iPhone 15",
    desc: " Powered by the A16 Bionic Processor, it excels in computational photography and more, all while conserving battery life.",
